                    ...
                    <div className="text-center">
                      <div className="mb-2">
                        <span className="text-sm font-medium text-gray-600">
                          {metricData.is_binary ? 'Exact Agreement' : 'Adjacent Agreement (within ±1)'}
                        </span>
                      </div>
                      <div className={`text-4xl font-bold ${getScoreColor(metricData.score)}`}>
                        {metricData.score.toFixed(1)}%
                      </div>
                      {!metricData.is_binary && metricData.exact_agreement !== undefined && (
                        <div className="text-sm text-gray-500 mt-1">
                          Exact agreement: {metricData.exact_agreement.toFixed(1)}%
                        </div>
                      )}
                      <div className="mt-2">
                      ...
                      {metricData.krippendorff_alpha != null && (
                        <div className="text-xs text-gray-400 mt-2">
                          Krippendorff's α: {metricData.krippendorff_alpha.toFixed(3)}
                        </div>
                      )}
                    </div>

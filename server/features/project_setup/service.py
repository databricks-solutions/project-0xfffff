...
class ProjectSetupService:
    ...
    def start_setup(self, request: ProjectSetupRequest, *, facilitator_id: str) -> ProjectSetupResponse:
        project = self.repository.create_project(request, facilitator_id=facilitator_id)
